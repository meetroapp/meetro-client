...
function MessagesInbox({ setPage, currentPage }) {
  ...
  function getEmergencyConversation() {
    const emergencySaved =
      localStorage.getItem("meetro_conversation_emergency-active-request") ||
      localStorage.getItem("meetro_emergency_conversation_meta");
    ...
    return {
      ...
      unread:
        localStorage.getItem(
          "meetro_conversation_read_emergency-active-request"
        ) !== "true",
