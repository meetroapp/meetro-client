...
function CustomerRelationshipsCenter({ setPage }) {
  ...
  const copy = isSpanish
    ? {
        ...
        description:
          "Un espacio interno para continuar relaciones con clientes despues del trabajo.",
        unavailable: "Las relaciones con clientes aun no estan disponibles.",
        detail:
          "Los registros verificados apareceran aqui cuando esta funcion este conectada a datos de produccion.",
        back: "Volver a Herramientas del negocio",
      }
    : {
        title: "Customer Relationships",
        description:
          "An internal workspace for continuing customer relationships beyond the work.",
        unavailable: "Customer relationships are not available yet.",
        detail:
          "Verified customer relationship records will appear here after this feature is connected to production data.",
  ...
  return (
    <div className="app-page meetro-responsive-page" style={page}>
      ...
      <main style={workspace} aria-labelledby="customer-relationships-unavailable-title">
        <section style={unavailableCard} role="status">
          <h2 id="customer-relationships-unavailable-title" style={unavailableTitle}>
            {copy.unavailable}
          </h2>
