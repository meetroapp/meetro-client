...
const counterBadge = {
  ...
  lineHeight: 1,
  boxShadow:
    "inset 0 1px 0 rgba(255,255,255,0.30), 0 5px 14px rgba(7,19,12,0.18)",
...
const slideButton = {
  ...
  boxShadow:
    "inset 0 1px 0 rgba(255,255,255,0.48), inset 0 -1px 0 rgba(255,255,255,0.08), 0 8px 22px rgba(7,19,12,0.22)",
