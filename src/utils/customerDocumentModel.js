...
function model({
  ...
  return Object.freeze({
    ...
    ...(optionalText(pricingNote, 1000) ? { pricingNote: optionalText(pricingNote, 1000) } : {}),
    ...(depositDueMinor == null ? {} : { depositDueMinor: minor(depositDueMinor) }),
    ...(remainingBalanceMinor == null ? {} : { remainingBalanceMinor: minor(remainingBalanceMinor) }),
    ...(optionalText(depositLabel, 240) ? { depositLabel: optionalText(depositLabel, 240) } : {}),
...
export function buildQuickQuoteDocumentModel(
  ...
  return model({
    ...
    depositDueMinor: draft?.depositDue == null ? null : majorToMinor(draft.depositDue),
    remainingBalanceMinor: draft?.remainingBalance == null ? null : majorToMinor(draft.remainingBalance),
