...
test("iPad landscape bounds conversation height and prevents stale portrait overflow", () => {
  const placement = calculateExpandedPanelPlacement({
    viewport: { width: 1024, height: 768, offsetLeft: 0, offsetTop: 0 },
    launcherRect: { left: 878, top: 548, width: 126, height: 50 },
