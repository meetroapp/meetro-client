...
test("shared visual identity tokens exist in the global stylesheet", () => {
  [
    "--meetro-color-forest: #0B5D3B",
    "--meetro-color-forest-deep: #063D26",
    "--meetro-color-sage: #E8F5EE",
    "--meetro-color-sage-soft: #E8F5EE",
    "--meetro-color-cream: #F7F6F2",
    "--meetro-color-paper: #FFFFFF",
    "--meetro-color-wood: #b7791f",
    "--meetro-color-coffee: #4a3428",
    "--meetro-color-charcoal: #111827",
    "--meetro-color-charcoal-soft: #374151",
