...
const highTrafficKeys = [
  ...
  "communityDiscoveryBarAria",
  "communityDiscoverySearchPlaceholder",
  "communityDiscoveryInterestsAria",
  "communityInterestPromptTitle",
  "communityInterestPromptCopy",
  "communityInterestSkip",
  "communityInterestMore",
  "communityInterestHomeServices",
  "communityInterestPropertyManagement",
  "communityInterestRealEstate",
  "communityInterestMarketing",
  "communityInterestBusinessServices",
  "communityInterestLegal",
  "communityInterestCreative",
  "communityInterestHealthcare",
  "communityInterestTransportation",
  "communityInterestEducation",
